...
export const register = async (req, res) => {
  try {
    const {
      email, password, firstName, lastName, userName, address, country, state, contactNo, dateOfBirth, accountType, branchName, initialDepositAmount, identificationProofType, identificationDocumentNo
    } = req.body;
